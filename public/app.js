    ...
    app.innerHTML=`
      ...
      <div class="admin-shell v37-shell">
        <header class="v37-mobile-header">
          ...
          <div class="v37-brand"><span>ص</span><b>صلّحلي</b></div>
        ...
        <aside class="admin-sidebar v37-drawer">
          <div class="v37-drawer-title">
            <div class="admin-logo"><span>ص</span>صلّحلي</div>
  ...
  window.home = home = function(){
    ...
    <section class="v40-home">
      ...
      <div class="v40-hero-card">
        <div class="v40-brand-big"><span>ص</span><div><b>صلّحلي</b><small>الفني الأقرب لك بضغطة زر</small></div></div>
